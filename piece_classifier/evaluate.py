...
def main():
    ...
    DEFAULT_SAVED_MODELS_DIR = os.path.join(os.path.dirname(os.path.dirname(__file__)), "saved_models", "pieces", "cnn_100.pth")
    DEFAULT_EVAL_PATH = "/Users/alexshan/Desktop/chesscog/data/pieces/val"
